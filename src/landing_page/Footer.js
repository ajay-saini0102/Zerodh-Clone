    ...
    <>
      <div className="container">
        <div className="row">
          <div className="col-3">
            <img
              ...
              style={{ width: "50%" }}
            />
            <p className="mt-3 text-muted" style={{fontSize:"0.8rem"}}>© 2010 - 2024, Zerodha Broking Ltd. All rights reserved.</p>
            <div className="col-10 fs-5">
              ...
              <a href="" className="text-muted">
                <i class="fa-brands fa-youtube mx-3 mt-4"></i>
              </a>
              <a href="" className="text-muted">
        ...
        <div className="text-center text-muted p-3">
          <a href="" className="footer-links text-muted">
            NSE
          </a>
          <a href="" className="footer-links text-muted">
            BSE
